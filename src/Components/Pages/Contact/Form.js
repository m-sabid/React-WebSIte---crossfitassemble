    ...
    <div className="mt-16 bg-[#1A191A] py-10 md:py-20">
      <div className="mid-container md:flex justify-between items-center  ">
        <div className="md:w-[50%] mb-4 md:mb-0">
          <h2 className="text-4xl font-semibold text-white c-white">
            Want to join us?
          </h2>
          <h2 className="text-4xl font-semibold text-white mt-1 c-white">
            Let's discuss
          </h2>
          <p className="text-secondary mt-5 tracking-wider c-white">
            Thank you for getting in touch!
          </p>
          <p className="text-secondary tracking-wider"></p>
          <p className="text-secondary tracking-wider c-white">
