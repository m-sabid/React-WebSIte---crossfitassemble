...
const AllPackages = () => {
  ...
  const currentPackage = packages?.data?.filter(
    (item) => item?.package_type?.package_title !== "Crossfit"
  );
        ...
        return (
          <div key={item.id} className="shadow-xl rounded-md">
            <div className="lg:h-[80px] flex items-center justify-center">
              <h1 className="text-center text-2xl font-bold pt-5 mb-2">
                {item?.package_type?.package_title}
              </h1>
            </div>
            ...
            <div className="card-body pt-0">
              <div className="text-center">
                {/* <h1 className="text-2xl font-bold text-primary mx-auto flex justify-center items-end">
                  ৳ {item?.discounted_price?.split(".")[0]}/
              ...
              <p className="text-xs text-secondary text-justify">
              ...
              <div className="ml-4 list-none">
                ...
                <li className="mb-1 ">
                  Total Consultation : {item?.total_consultation}
                </li>
              </div> */}
              <div
                onClick={() => {
