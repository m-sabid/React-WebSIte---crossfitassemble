...
import KickBoxing from '../ProgrammeData/KickBoxing';   
import SingleGroupClassPass from './../ProgrammeData/SingleGroupClassPass';
...
const Tabs = props => {
    ...
    } else if (selected === "kick-boxing") {
        section = <KickBoxing />
    } else if (selected === "single-roup-class-pass") {
        section = <SingleGroupClassPass />
    }
