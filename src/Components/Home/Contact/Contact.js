...
const Contact = () => {
  ...
  return (
    <div className="mid-container">
      <h1 className="md:text-4xl text-3xl font-bold text-primary mb-7 mt-16">
        Contact us
      </h1>
          ...
          <div className=" pb-5 flex justify-center">
            <div className="flex gap-3">
              ...
              <div className="grid gap-2">
                <h2 className=" font-semibold text-sm">Saturday To Thursday</h2>
                <h2 className=" font-semibold text-sm text-center">7:00AM To 10:00PM</h2>
          ...
          <div className=" pb-5 flex justify-center">
            <div className="flex gap-3">
              <div className="grid gap-2 mt-1">
                ...
                <BsFacebook className="text-primary" />
                <GrInstagram className="text-primary" />
                <GrLinkedin className="text-primary" />
              </div>
              <div className="grid gap-2">
