        ...
        <div className="navbar bg-transparent text-white z-50">
            ...
            <div className="navbar-end hidden lg:flex">
                <ul className="menu menu-horizontal p-0">
                    ...
                    <li><CustomLink to='/about' className="uppercase hover_effect font-semibold text-sm text-[12px] p-2" href="#">About Us</CustomLink></li>
                    ...
                    <li><CustomLink to='/programs' className="uppercase hover_effect font-bold text-sm text-[12px] p-2" href="#">Other Programs</CustomLink></li>
                    <li><CustomLink to='/trainers' className="uppercase hover_effect font-bold text-sm text-[12px] p-2" href="#">Our Team</CustomLink></li>
                ...
                <div className=" dropdown-end ">
...

                    {
                        isOpen && <ul className="menu menu-compact  absolute mr-[30px] md:mr-[55px] dropdown-content mt-3 p-2 shadow  rounded-box w-52 bg-[#dbe5fa] z-50 text-black ">
                            ...
                            <li><Link to='/about' className="uppercase hover_effect font-bold text-sm" href="#">About US</Link></li>
